...
The 'databricks_demo_dab_07' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/databricks_demo_dab_07/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_demo_dab_07_etl` to your workspace.
